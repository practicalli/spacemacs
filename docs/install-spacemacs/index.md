...
![Fira Code font - ligatures for Emacs and Clojure code](/spacemacs/images/fira-code-font-ligatures-clojure.png)
...
![Spacemacs - doom-gruvbox-light theme - home and spacemacs config buffers](/spacemacs/images/spacemacs-doom-gruvbox-light-theme-examples-home-spacemacs-config.png)
